...
<section class="container-fluid">
  ...
  <div class="row">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <form action="${pageContext.request.contextPath}/admin/blog/writeUI" method="post" >
        <h1 class="page-header">操作</h1>
        <ol class="breadcrumb">
          <li><a href="${pageContext.request.contextPath}/admin/blog/writeUI">增加文章</a></li>
        </ol>
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>${blog.col}</td>
                <td class="hidden-sm">${blog.sign}</td>
                <td><fmt:formatDate value="${blog.releaseDate}" pattern="yyyy-MM-dd"/></td>
                <td>
                  <a href="${pageContext.request.contextPath}/admin/blog/updateUI?blogId=${blog.blogId}">修改</a>
                  <a rel="6" onclick="javascript:return del()" href="${pageContext.request.contextPath}/admin/blog/delete?blogId= ${blog.blogId}">删除</a></td>
              </tr>
              </c:forEach>
            </tbody>
          </table>
