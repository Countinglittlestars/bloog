...
<section class="container-fluid">
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        <li class="active"><a href="${pageContext.request.contextPath}/admin/blog/select">文章</a></li>
        <li><a href="#">公告</a></li>
        <li><a href="${pageContext.request.contextPath}/admin/comment/selectAll">评论</a></li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-lg-10 col-md-offset-2 main" id="main">
      <div class="row">
        <form action="${pageContext.request.contextPath}/admin/blog/update?blogId=${blog.blogId}" method="post" class="add-article-form">
          <div class="col-md-9">
            ...
            <div class="form-group">
              ...
              <script id="article-content" name="content" type="text/plain">${blog.content}</script>
            </div>
            <%--<div class="add-article-box">--%>
              <%--<h2 class="add-article-box-title"><span>关键字</span></h2>--%>
              <%--<div class="add-article-box-content">--%>
              	<%--<input type="text" class="form-control" placeholder="请输入关键字" name="sign" autocomplete="off">--%>
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
              	<textarea class="form-control" name="summary" autocomplete="off">${blog.summary}</textarea>
          ...
          <div class="col-md-3">
            ...
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <ul class="category-list">
                  <li>
                    <label>
                      <input name="col" type="radio" value="首页" checked>
                      首页 <em class="hidden-md"></em></label>
                  </li>
                  <li>
                    <label>
                      <input name="col" type="radio" value="精选分享">
                        精选分享 <em class="hidden-md"></em></label>
                  </li>
                  <li>
                    <label>
                      <input name="col" type="radio" value="读书">
                       读书 <em class="hidden-md"></em></label>
                  </li>
                  <li>
                    <label>
                      <input name="col" type="radio" value="胡言乱语">
                      胡言乱语 <em class="hidden-md"></em></label>
                  </li>
                  <li>
                    <label>
                      <input name="col" type="radio" value="留言板">
                      留言板 <em class="hidden-md"></em></label>
                  </li>
                </ul>
              </div>
            </div>
            <div class="add-article-box">
              ...
              <div class="add-article-box-content">
                <input type="text" class="form-control" placeholder="输入新标签" name="sign" autocomplete="off" value="${blog.sign}">
...
<script id="uploadEditor" type="text/plain" style="display:none;"></script><script type="text/javascript">
