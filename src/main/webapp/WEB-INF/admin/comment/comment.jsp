...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resources/css/admin/font-awesome.min.css">
...
<section class="container-fluid">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="${pageContext.request.contextPath}/admin/admin/logout" onClick="if(!confirm('是否确认退出？'))return false;">退出登录</a></li>
  ...
  <div class="row">
    <aside class="col-sm-3 col-md-2 col-lg-2 sidebar">
      ...
      <ul class="nav nav-sidebar">
        <li><a href="${pageContext.request.contextPath}/admin/blog/select">文章</a></li>
        <li><a href="#">公告</a></li>
        <li class="active"><a href="${pageContext.request.contextPath}/admin/comment/selectAll">评论</a></li>
      ...
      <ul class="nav nav-sidebar">
        <li><a class="dropdown-toggle" id="userMenu" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">用户</a>
          <ul class="dropdown-menu" aria-labelledby="userMenu">
            <li><a href="${pageContext.request.contextPath}/admin/admin/select">管理用户</a></li>
      ...
      <form action="/Comment/checkAll" method="post">
        ...
        <div class="table-responsive">
          <table class="table table-striped table-hover">
            <thead>
              <tr>
                <th><span class="glyphicon glyphicon-th-large"></span> <span class="visible-lg">通过</span></th>
            ...
            <c:forEach items="${commentList}" var="comment">
              <tr>
                <td>${comment.available}</td>
                <td class="article-title">${comment.comment}</td>

                <td><fmt:formatDate value="${comment.createTime}" pattern="yyyy-MM-dd"/></td>
                <td>
                  <a href="${pageContext.request.contextPath}/admin/comment/activeByPrimaryKey?cId=${comment.cId}" >通过</a>
                  <a href="${pageContext.request.contextPath}/admin/comment/banByPrimaryKey?cId=${comment.cId}" >禁止</a></td>
                  <%--${pageContext.request.contextPath}/admin/comment/activeByPrimaryKey?cId=${comment.cId}--%>
                  <%--${pageContext.request.contextPath}/admin/comment/banByPrimaryKey?cId=${cId}--%>
              </tr>
              </c:forEach>
            </tbody>
          </table>
...
<div class="modal fade user-select" id="WeChat" tabindex="-1" role="dialog" aria-labelledby="WeChatModalLabel">
  <div class="modal-dialog" role="document" style="margin-top:120px;max-width:280px;">
    <div class="modal-content">
      ...
      <div class="modal-body" style="text-align:center"> <img src="${pageContext.request.contextPath}/resources/image/admin/weixin.jpg" alt="" style="cursor:pointer"/> </div>
    </div>
  </div>
</div>
<!--提示模态框-->
<div class="modal fade user-select" id="areDeveloping" tabindex="-1" role="dialog" aria-labelledby="areDevelopingModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body"> <img src="${pageContext.request.contextPath}/resources/image/admin/baoman/baoman_01.gif" alt="深思熟虑" />
...
<script src="${pageContext.request.contextPath}/resources/js/admin/admin-scripts.js"></script>
<%--<script>--%>
<%--$(function () {--%>
