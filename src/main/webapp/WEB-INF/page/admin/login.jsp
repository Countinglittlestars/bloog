...
<div class="container">
  ...
  <form action="${pageContext.request.contextPath}/page/admin/login" method="post" autocomplete="off" class="form-signin">
    <h2 class="form-signin-heading">用户登录</h2>
    <label for="userName" class="sr-only">用户名</label>
    <input type="text" id="userName" name="account" class="form-control" placeholder="请输入用户名" required autofocus autocomplete="off" maxlength="10">
  ...
  <a href="${pageContext.request.contextPath}/page/admin/registerUI"><button class="btn btn-primary">注册</button></a>
  <%--<div class="footer">--%>
